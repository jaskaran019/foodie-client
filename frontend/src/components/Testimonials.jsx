      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="md:w-1/2">
          <div className="text-left md:w-4/5">
            ...
            <blockquote className='my-5 text-secondary leading-[30px]'>“I had the pleasure of dining at Foodie last night, and I'm still raving about the experience! The attention to detail in presentation and service was impeccable”</blockquote>
